...
export const MenuNav =
    <ul className="menulnks">
        ...
        <li><a className="menulnk" data-menu="hallmenu">Halloween Party</a></li>
        <li><a className="menulnk" data-menu="hhdpmenu">Hip Hop Dance Party</a></li>
        <li><a className="menulnk" data-menu="horsmenu">Hors D'Oeuvres</a></li>
        <li><a className="menulnk" data-menu="icpmenu">Italian Cocktail Party</a></li>
        <li><a className="menulnk" data-menu="lnimenu">Ladies Night In</a></li>
        <li><a className="menulnk" data-menu="mcnmenu">Monte Carlo Night</a></li>
        <li><a className="menulnk" data-menu="nonmenu">New Orleans Night</a></li>
        <li><a className="menulnk" data-menu="pspmenu">Paella and Sangria Party</a></li>
        <li><a className="menulnk" data-menu="ppmenu">Picnic in the Park</a></li>
        <li><a className="menulnk" data-menu="rdtmenu">Romantic Dinner for Two</a></li>
        <li><a className="menulnk" data-menu="sbmenu">Shower Brunch Menu</a></li>
        <li><a className="menulnk" data-menu="socomenu">Southern Comfort</a></li>
        <li><a className="menulnk" data-menu="sccpmenu">Southern Comfort Cocktail Party</a></li>
        <li><a className="menulnk" data-menu="tgfmenu">Tuscan Grilled Feast</a></li>
        <li><a className="menulnk" data-menu="vegnmenu">Vegas Night</a></li>
        <li><a className="menulnk" data-menu="vmpmenu">Venetian Masquerade Party</a></li>
...
export const MenuContents =
    <div>
        <div id="wedmenu" className="menu">
            <ul>
                <li>
                    <div className="header">Entrées</div>
                    <ul>
                ...
                <li>
                    <div className="header">Soups</div>
                    <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <div className="summary">Homemade Salad Dressings</div>
                            <ul>
                ...
                <li>
                    <div className="header">Breads</div>
                    <ul>
                        <li>Yeast Rolls</li>
                        <li>Biscuits</li>
                        <li>Garlic Knots</li>
                ...
                <li>
                    <div className="header">Specialty Drinks*</div>
                    <ul>
                    ...
                    <div className="note">*Alcohol is not included but can be added on site by Chef Laura</div>
                </li>
                <li>
                    <div className="header">Appetizer Platters</div>
                    <ul>
                        <li>
                            <div className="summary">Option A (feeds 8 - 10)</div>
                            <ul>
                        ...
                        <li>
                            <div className="summary">Option B (feeds 8 - 10)</div>
                            <ul>
        ...
        <div id="gdmenu" className="menu">
            <ul>
                <li>
                    <div className="header">Finger Food</div>
                    <ul>
                ...
                <li>
                    <div className="header">Main Dishes</div>
                    <ul>
                        <li>Chili with Cheddar, Scallions and Sour Cream</li>
                    </ul>
                </li>
                <li>
                    <div className="header">Sandwiches</div>
                    <ul>
                ...
                <li>
                    <div className="header">Brownie Variations</div>
                    <ul>
                ...
                <li>
                    <div className="header">House Made Drinks</div>
                    <ul>
                        <li>Lemonade</li>
        ...
        <div id="hallmenu" className="menu">
            <ul>
                <li>
        ...
        <div id="hhdpmenu" className="menu">
            <ul>
                <li>
                    <div className="header">Drinks</div>
                    <ul>
                    ...
                    <div className="note">*If you choose for the drinks to include alcohol, it must be purchased by host</div>
                </li>
                <li>
                    <div className="header">Entrees</div>
                    <ul>
        ...
        <div id="horsmenu" className="menu">
            <ul>
            ...
            <div className="note">All items are 3 per person unless otherwise noted</div>
        </div>
        <div id="icpmenu" className="menu">
            <div className="summary">Italian Ciabatta Bread Toasts with a variety of toppings including:</div>
            <ul>
        ...
        <div id="lnimenu" className="menu">
            <ul>
                <li>
                    <div className="header">Canapés</div>
                    <ul>
                ...
                <li>
                    <div className="header">Salad</div>
                    <ul>
        ...
        <div id="pspmenu" className="menu">
            <div className="summary">Local Farm Fresh Gazpacho with Ceviche Topping</div>
            <ul>
                <li>
                    <div className="header">Paella Choices</div>
                    <ul>
                        <li>
                            <div className="header">Black Squid Paella</div>
                            <ul>
                                <li>Fresh Squid</li>
                                <li>Squid Ink</li>
                                <li>Artichokes</li>
                        ...
                        <li>
                            <div className="header">Vegetable Paella</div>
                            <ul>
                                <li>Eggplant</li>
                                <li>Zucchini</li>
                                <li>Yellow Squash</li>
                        ...
                        <li>
                            <div className="header">Chicken and Mushroom Paella</div>
                            <ul>
                        ...
                        <li>
                            <div className="header">Shrimp and Asparagus Paella</div>
                            <ul>
                                <li>Shrimp</li>
                                <li>Asparagus</li>
                            </ul>
                ...
                <li>
                    <div className="header">Sangria Choices</div>
                    <ul>
        ...
        <div id="ppmenu" className="menu">
            <ul>
                ...
                <li>
                    <div className="header">Burger Variations*</div>
                    <ul>
                        <li>Fresh Ground Chuck Burger with Bacon and Cheddar</li>
                        <li>Fresh Ground Chuck Burger with Blue Cheese Cream Sauce and Applewood Smoked Bacon</li>
                        <li>Fresh Ground Chuck with Caramelized Onions, Sautéed Mushrooms and Swiss Cheese</li>
                    ...
                    <div className="note">*Burgers include Buns, Condiments, Sliced Tomatoes, Lettuce Leaves, Sliced Onions and Bread and Butter Pickles</div>
                </li>
                <li>
                    <div className="header">Chicken Breast Sandwich Variations*</div>
                    <ul>
                    ...
                    <div className="note">*Sandwiches include Buns, Condiments, Sliced Tomatoes, Lettuce Leaves, Sliced Onions and Bread and Butter Pickles</div>
                </li>
                <li>
                    <div className="header">Picnic Sides</div>
                    <ul>
                        <li>Coleslaw</li>
                        <li>Mexican Coleslaw</li>
                        <li>North Carolina Style Coleslaw</li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>Red Sangria with your Favorite Fruits</li>
                        <li>
                            <div className="header">Smoothie, Daiquiri, Mojito or Margarita Base</div>
                            <ul>
                                <li>Strawberry</li>
                                <li>Peach</li>
                                <li>Mango</li>
                    ...
                    <div className="note">You pick the sweetener used for the simple syrup - Agave, Honey, Raw Brown Sugar, White Sugar, or Splenda</div>
                </li>
            </ul>
        </div>
        <div id="rdtmenu" className="menu">
            <ul>
                <li>
                    <div className="header">Canapés</div>
                    <ul>
        ...
        <div id="socomenu" className="menu">
            <div>
                <ul>
                    <li>
                        <div className="header">First Course</div>
                        <ul>
                    ...
                    <li>
                        <div className="header">Main Course</div>
                        <ul>
                    ...
                    <li>
                        <div className="header">Assorted Pie Display</div>
                        <ul>
                            <li>Sweet Potato Pie</li>
        ...
        <div id="sccpmenu" className="menu">
            <ul>
                <li>Individual Shrimp and Grits Cocktail Glass</li>
                <li>Collard Green Wrap with Crisp Bacon and Julienned Leeks and Carrots</li>
        ...
        <div id="tgfmenu" className="menu">
            <ul>
                ...
                <li>
                    <div className="header">Suggested Drink – Tuscan Sangria</div>
                    <ul>
                        <li>Sangiovese or Chianti*</li>
                        <li>Fresh Orange Juice</li>
                        <li>Tuaca Liqueur*</li>
                        <li>Vermouth*</li>
                        <li>Lime Juice</li>
                        ...
                        <li>Sugar</li>
                        <li>Ice</li>
                        <li>Cinnamon Sticks and Orange Slices</li>
                    </ul>
                    <div className="note">*Host must purchase alcohol</div>
                </li>
            </ul>
            <div className="note">Chef will prep non-alcohol related ingredients at party!</div>
        </div>
        <div id="vegnmenu" className="menu">
            <ul>
                <li>
                    <div className="header">Canapés</div>
                    <ul>
        ...
        <div id="vdmenu" className="menu">
            <ul>
                ...
                <li>
                    ...
                    <div className="note">
                        All alcohol must be purchased by host
                    </div>
                </li>
            </ul>
        </div>
